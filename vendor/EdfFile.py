# -*- coding: utf-8 -*-
"""
Created on Wed May  2 15:10:53 2018
...
class  EdfFile:
    ...
    def __init__(self, FileName, access=None, fastedf=None):
        ...
        Index = 0
        line = self.File.readline().decode('utf-8') # OBS: Concession for Windows?
...
#            Position = self.File.tell()
        ...
        if self.ADSC:
            ...
            if SysByteOrder.upper() != Images[Index].ByteOrder.upper():
...
def SetDictCase(Dict, Case, Flag):
    ...
    for i in Dict.keys():
        ...
        if Flag & VALUES:
            if Case == LOWER_CASE:  newvalue = newkey.lower()
            else:                   newvalue = newkey.upper()
